    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <span class='mb-3 d-inline-block fw-bold text-muted'>Our Mission</span>

                <p class='text-muted' style='text-align:justify;'>Our mission at Forever is to empower customers with choice, convenience, and confidence. We're dedicated to providing a seamless shopping experience that exceeds expectations, from browsing and ordering to delivery and beyond.</p>
            </div>
            <!-- <div class="col-6">
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h5 class='text-muted text-uppercase my-5'>Why <span class='fw-bold text-dark'>Choose Us</span><i class="fa-solid fa-minus" style='color:#2A2A2A'></i></h5>
            </div>
        </div>
        <div class="row">
