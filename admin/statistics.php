...
<section class='dashboard-page position-relative'>
    <div class="container">
        <div class="row mt-5">
            ...
            <div  class="col-9 ">
                <div data-aos="fade-up" data-aos-duration="1000" class="row bg-white g-0 mt-4 p-3 py-4" >
                ...
                <div data-aos="fade-up" data-aos-duration="3000" class="row">
                    <div class="col-lg-8 mt-5" >
                        ...
                        ?>
                        <div style='box-shadow:0 0 10px 1px #33333321;' class='p-3 rounded-3'>
                                    ...
                                    while($row6 = mysqli_fetch_assoc($result6)){
                                        ...
                                        echo "<div class='d-flex justify-content-between border-bottom py-2'>
                                                ...
                                                <div>
                                                    ...
                                                    <p class='mb-0 text-{$textColor} text-capitalize' style='font-size:14px; line-height:15px;'>{$row6['order_status']}</p>
                                                </div>
                                            </div>";
                                    }
                                }else{
