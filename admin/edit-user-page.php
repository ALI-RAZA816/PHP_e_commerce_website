                        ...
                        <form action="" class='row px-4 pb-3 g-0 form '>
                            ...
                            <div class="col-12 mt-4 status">
                                ...
                                <div class='row p-0 g-0'>
                                    <div class='col-4'>
                                        <label for="" style='width:100%;' class='p-2'>
                                            <input type="radio" name='status' class='active-selection' id='active' hidden>
                                    ...
                                    <div class='col-4'>
                                        <label for="" style='width:100%;' class='p-2'>
                                            <input type="radio" name='status' class='inactive-selection' id='inactive' hidden>
                                    ...
                                    <div class='col-4'>
                                        <label for="" style='width:100%;' class='p-2'>
                                            <input type="radio" name='status' class='suspend-selection' id='suspend' hidden>
                            ...
                            <button type='button' class='btn btn-outline-success ms-2 mt-2'>Save Changes</button>
                        </form>
                    </div>
            </div>
        </div>
