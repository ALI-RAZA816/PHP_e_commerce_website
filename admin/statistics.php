    ...
    <div class="container-fluid p-0">
        <div class="row p-0">
            <div class="col-2 p-0 border-end" style='background-color:#F5F4ED;'>
                <?php 
                    include "sidebar.php";
                    $query = "SELECT *, SUM(quantity * unitprice) + 1 AS revenue FROM orders WHERE order_status = 'deliverd'";
                ...
                <div data-aos="fade-up" data-aos-duration="1000" class="row g-0 mt-md-4 px-3 py-4">
                    <div class="col-md-6 col-lg-3 mt-4 mt-lg-0 pe-md-3" >
                        <div class='rounded-3 dashboard-cards bg-white p-3' style='box-shadow:0 2px 10px 1px rgba(51, 51, 51,.05);'>
                            ...
                            <h3 class='m-0 fs-3 fw-bold'>$ <?php echo $revenue['revenue'] ?  number_format($revenue['revenue']) : 0 ?></h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 mt-4 mt-lg-0 px-lg-3">
                        <div class='rounded-3 dashboard-cards bg-white p-3' style='box-shadow:0 2px 10px 1px rgba(51, 51, 51,.05);'>
                            ...
                            <h3 class='m-0 fs-3 fw-bold'><?php echo number_format($placeOrder['place_orders']) ?></h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 mt-4 mt-lg-0 pe-md-3 px-lg-3">
                        <div class='rounded-3 dashboard-cards bg-white p-3' style='box-shadow:0 2px 10px 1px rgba(51, 51, 51,.05);'>
                            ...
                            <h3 class='m-0 fs-3 fw-bold'><?php echo number_format($customers['customer']) ?></h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 mt-4 mt-lg-0  ps-lg-3">
                        <div class='rounded-3 dashboard-cards bg-white p-3' style='box-shadow:0 2px 10px 1px rgba(51, 51, 51,.05);'>
                            ...
                            <h3 class='m-0 fs-3 fw-bold'><?php echo number_format($cancelledOrder['c_order']) ?></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div  class='p-3 overflow-hidden delivery-status bg-white rounded-3' style='box-shadow:0 0 10px 1px rgba(51, 51, 51,.08);'>
                            ...
                            <div class='mb-3 py-2'>
                                <div class='d-flex justify-content-between'>
                                    ...
                                    <p class='mb-0 fw-bold' style='color:#064E38;'><?php echo $deliver_avg ? $deliver_avg : 0 ?>%</p>
                                </div>
                                <div class='w-100 rounded-2' style='background-color:#F4ECE8;'>
                                    <div class='rounded-2 'style='background-color:#003527;height:8px;width:<?php echo $deliver_avg ? $deliver_avg : 0 ?>%;'></div>
                                </div>
                            </div>
                            <div class='mb-3 py-2'>
                                <div class='d-flex justify-content-between'>
                                    ...
                                    <p class='mb-0 fw-bold' style='color:#064E38;'><?php echo $packing_avg ? $packing_avg : 0 ?>%</p>
                                </div>
                                <div class='w-100 rounded-2' style='background-color:#F4ECE8;'>
                                    <div class='rounded-2' style='background-color:#627E74;height:8px;width:<?php echo $packing_avg ? $packing_avg : 0 ?>%;'></div>
                                </div>
                            </div>
                            <div class='mb-3 py-2'>
                                <div class='d-flex justify-content-between'>
                                    ...
                                    <p class='mb-0 fw-bold'  style='color:#064E38;'><?php echo $shipping_avg ? $shipping_avg : 0 ?>%</p>
                                </div>
                                <div class='w-100 rounded-2' style='background-color:#F4ECE8;'>
                                    <div class='rounded-2' style='background-color:#31594E;height:8px;width:<?php echo $shipping_avg ? $shipping_avg : 0 ?>%;'></div>
                                </div>
                            </div>
                            <div class='mb-3 py-2'>
                                <div class='d-flex justify-content-between'>
                                    ...
                                    <p class='mb-0 fw-bold' style='color:#064E38;'><?php echo $outdelivery_avg ? $outdelivery_avg : 0 ?>%</p>
                                </div>
                                <div class='w-100 rounded-2' style='background-color:#F4ECE8;'>
                                    <div class='rounded-2 bg-secondary' style='background-color:#627E74;height:8px;width:<?php echo $outdelivery_avg ? $outdelivery_avg : 0 ?>%;'></div>
                                </div>
                            </div>
                            <div class='mb-3 py-2'>
                                <div class='d-flex justify-content-between'>
                                    ...
                                    <p class='mb-0 fw-bold'style='color:#064E38;'><?php echo $cancelled_avg ? $cancelled_avg : 0 ?>%</p>
                                </div>
                                <div class='w-100 rounded-2' style='background-color:#F4ECE8;'>
                                    <div class='rounded-2 bg-danger' style='height:8px;width:<?php echo $cancelled_avg ? $cancelled_avg : 0 ?>%;'></div>
                                </div>
                            </div>
                        </div>
                    </div>
