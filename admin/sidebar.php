<div class='sidebar border-end py-2 overflow-hidden vh-100'>
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link dashboard-links text-dark border border-end-0 mb-3 rounded-start-2 d-flex align-items-center" href="bestseller.php"><i class="fa-solid fa-holly-berry fs-5 me-2"></i><span class='d-none d-md-block'>BestSeller</span></a></li>
